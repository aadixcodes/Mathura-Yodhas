...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="w-full font-[Para-1] sticky top-0 z-50">
        {/* Bottom Section */}
        <div className="text-black lg:px-36 px-6 bg-[#fcd700] md:bg-[#fcd700] h-16 flex items-center relative">
          {/* Desktop Layout */}
          <div className="hidden sm:flex items-center justify-between w-full">
            {/* Left Links - Adjusted spacing */}
            <div className="flex gap-6 lg:gap-10 font-[popins] text-lg lg:text-xl ml-auto mr-12">
              <Link
                href="/"
                className="cursor-pointer hover:text-[#4f0516] transition-colors whitespace-nowrap"
              >
            ...
            {/* Center Logo - Slightly increased size */}
            <Link href="/" className="flex justify-center items-center h-[7.5rem] w-[7.5rem] mt-[1.5rem] z-10 relative mx-4 cursor-pointer transition-opacity">
              <Image
                src={"/assets/mathura.png"}
                alt="Ayodhya Super Kings"
                fill
            ...
            {/* Right Links - Adjusted spacing */}
            <div className="flex gap-6 lg:gap-10 font-[popins] text-lg lg:text-xl mr-auto ml-12">
              <Link
                href="/team"
                className="cursor-pointer hover:text-[#4f0516] transition-colors whitespace-nowrap"
              >
          ...
          {/* Mobile Menu Overlay - Changed to normal blur without yellow tint */}
          {isOpen && (
            <div
